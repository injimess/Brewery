...
using BreweryBusiness.Services.Implementations;
...
namespace BreweryApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<BreweryDbContext>(opt => opt.UseSqlServer
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "BreweryApi", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "BreweryApi v1"));
            }
